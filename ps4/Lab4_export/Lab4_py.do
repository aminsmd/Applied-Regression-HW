...
// STOP STOP STOP STOP STOP STOP STOP STOP STOP STOP STOP STOP STOP STOP
	// SES is positively associated with science score,
	// there is a point there positive return of SES starts to level off, but
	// in real life we see mostly increase at an decreasing rate 
...
reg zscience7 zses $controls if lab4_sample==1 & dpublic==1
	...
	// controlling for prior achievement (5th grade), age, gender, and ethnicity, 
	// we expect students 1 SD higher in the SES composite measure is likely to score .10 SD higher (p-value < .001 ) on the grade 8 science test score, on average. 
...
// 1 SD increase in SES predicts .04 SD higher grade 8 science score, controlling for 
// prior year science test score and student background characteristics for students in private school 

// Q: what is the relationship between ses and science test score for students in public school? 
// STOP STOP STOP STOP STOP STOP STOP STOP STOP STOP STOP STOP STOP STOP1
// zses(0.0386) zsesxpublic(0.0639): add the two 
...
// STOP STOP STOP STOP STOP STOP STOP STOP STOP STOP STOP STOP STOP STOP1
// yeap, look at the interaction term 
...
* turns out you can also just do this
test zsesXpublic zscience6Xpublic ageXpublic dfemaleXpublic dblackXpublic dhispanicXpublic dasianXpublic dotherXpublic				
...
// STOP STOP STOP STOP STOP STOP STOP STOP STOP STOP STOP STOP STOP STOP1
 *interpret p4sadlon: every 1 unit increase in sad, on average, predicts .15 units higher externalizing behav, controlling for prior sadness
 *interpret dfemale: On average teachers reported less externalizing prob behav for females compared with males, controlling for prior sadness
 *interpret sadXfemale: the associaton between sad & extern is less pronounced for girls than boys
** draw the two lines out on board! 
